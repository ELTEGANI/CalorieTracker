    ...
    Box(
        ...
        Column(
            ...
            UnitTextField(
                ...
                onValueChange = {
                  nutrientGoalViewModel.onEvent(NutrientGaolEvent.OnCarbRatioEnter(it))
                },
            ...
            UnitTextField(
                ...
                onValueChange = {
                    nutrientGoalViewModel.onEvent(NutrientGaolEvent.OnProtienEnter(it))
                },
            ...
            UnitTextField(
                ...
                onValueChange = {
                    nutrientGoalViewModel.onEvent(NutrientGaolEvent.OnCarbFatEnter(it))
                },
        ...
        ActionButton(
            ...
            onClick = {
               nutrientGoalViewModel.onEvent(NutrientGaolEvent.OnNextClick)
            },
